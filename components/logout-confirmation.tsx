...
export function LogoutConfirmation({ action }: LogoutConfirmationProps) {
  ...
  return (
    <>
      ...
      {isOpen ? (
        <div className="fixed inset-0 z-50 grid place-items-center bg-background/55 px-5 py-8 backdrop-blur-sm">
          <div
            role="dialog"
            aria-modal="true"
            aria-labelledby="logout-title"
            aria-describedby="logout-description"
            className="app-surface w-full max-w-md p-5 shadow-xl"
          >
            ...
            <div className="text-center">
              ...
              >
                Kamu perlu login lagi untuk mengelola order, katalog, dan status
                pembayaran.
              </p>
            </div>
