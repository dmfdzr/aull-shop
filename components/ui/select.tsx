  ...
  return (
    ...
    >
      ...
      <SelectPrimitive.Icon asChild>
        <span
          aria-hidden="true"
          className="size-2.5 shrink-0 rotate-45 border-b-2 border-r-2 border-muted-foreground transition-transform duration-200 group-data-[state=open]/select:rotate-[225deg]"
        />
